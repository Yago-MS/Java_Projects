...
public class BibliotecaArraysActualizada {
    ...
    public static boolean busqueda2D (int[][] tabla, int num){
    boolean norepe = true;
        for (int indice1 = 0; indice1 < tabla.length; indice1++) {
            for (int indice2 = 0; indice2 < tabla[0].length; indice2++) {
                if(tabla[indice1][indice2] == num){
                norepe = false;
                }
    ...
    public static void tablaRandom2DSinRepe(int[][] tabla) {
    
        for (int indice1 = 0; indice1 < tabla.length; indice1++) {
            for (int indice2 = 0; indice2 < tabla[0].length; indice2++) {
                int num = (int) (Math.random()*1001);
                while(!busqueda2D(tabla, num)){
                num = (int) (Math.random()*1001);
                }
                tabla[indice1][indice2] = num ;
            }
        }
